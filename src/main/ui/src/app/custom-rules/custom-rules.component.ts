        ...
        <form name="form1" (ngSubmit)="saveCustomRules()" #f="ngForm" novalidate>
            ...
            <div id="form-step2" class="input-group"*ngIf="dataSource  && showDataSource">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="fontevoti">Fonte voti:</label>
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Seleziona la fonte voti da cui attingere per il calcolo."></i></div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="fontemb">Fonte bonus/malus:</label>
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Fonte bonus/malus Fantagazzetta"></i></div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="fonteae">Fonte ammonizioni/esplusioni:</label>
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Seleziona la fonte per le ammonizioni e le espulsioni"></i></div>
                    </div>
                </div>
            </div>
            ...
            <div id="form-step3" class="input-group" *ngIf="substitutions && showSubstitutions">
                <div class="col-lg-12 rowb">
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                            <input name="ctl00$main$nsostituzioni"  [(ngModel)]="substitutions.substitutionNumber" id="nsostituzioni" class="form-control" type="number">
                        </div>
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Inserisci il numero di sostituzioni da effettuare. Il valore deve essere un intero compreso tra 1 e 11"></i></div>
                    </div>
                    
                    <div id="sosmoduloclassic" class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="priorità">Modalità sostituzioni:</label>
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                        ...
                        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Seleziona la modalità delle sostituzioni"></i></div>
                    </div>


                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="amminitosv">Assegna voto ad ammonito sv:</label>
                        ...
                        <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Scegliere se impostare un valore di default per il calciatore ammonito con sv"></i></div>
                    </div>
                    ...
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="riservaufficiop">Riserva d'ufficio portieri:</label>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="radio">
                        ...
                        <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Scegliere se utilizzare la riserva d'ufficio per i portieri"></i></div>
                    </div>
                    ...
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="riservaufficiogm">Riserva d'ufficio giocatori di movimento:</label>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="radio">
                    ...
                    <div class="row innersel" style="display: block;">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="appriserva">Applica riserva d'ufficio fino al:</label>
                        <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
            ...
            <div id="form-step4" class="input-group" *ngIf="points && showPoints">
                <div class="col-lg-12 rowb">
                    ...
                    <div class="row inner nobor" >
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s1">Gol 1:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s1" [(ngModel)]="points.goalPoints[0]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s2">Gol 2:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s2" [(ngModel)]="points.goalPoints[1]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s3">Gol 3:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s3" [(ngModel)]="points.goalPoints[2]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s4">Gol 4:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s4" [(ngModel)]="points.goalPoints[3]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s5">Gol 5:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s5" [(ngModel)]="points.goalPoints[4]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s6">Gol 6:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s6" [(ngModel)]="points.goalPoints[5]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s7">Gol 7:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s7" [(ngModel)]="points.goalPoints[6]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s8">Gol 8:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s8" [(ngModel)]="points.goalPoints[7]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s9">Gol 9:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s9" [(ngModel)]="points.goalPoints[8]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s10">Gol 10:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s10" [(ngModel)]="points.goalPoints[9]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s11">Gol 11:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s11" [(ngModel)]="points.goalPoints[10]" type="number">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label" for="s12">Gol 12:</label>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner" name="s12" [(ngModel)]="points.goalPoints[11]" type="number">
                        </div>
                    </div>
                    ...
                    <div class="row" *ngIf = "points.formulaUnoPoints[0]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu1" [(ngModel)]="points.formulaUnoPoints[0]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[1]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu2" [(ngModel)]="points.formulaUnoPoints[1]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[2]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu3" [(ngModel)]="points.formulaUnoPoints[2]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[3]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu4" [(ngModel)]="points.formulaUnoPoints[3]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[4]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu5" [(ngModel)]="points.formulaUnoPoints[4]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[5]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu6" [(ngModel)]="points.formulaUnoPoints[5]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[6]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu7" [(ngModel)]="points.formulaUnoPoints[6]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[7]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu8" [(ngModel)]="points.formulaUnoPoints[7]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[8]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu9" [(ngModel)]="points.formulaUnoPoints[8]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[9]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu10" [(ngModel)]="points.formulaUnoPoints[9]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[10]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu11" [(ngModel)]="points.formulaUnoPoints[10]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[11]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu12" [(ngModel)]="points.formulaUnoPoints[11]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[12]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu13" [(ngModel)]="points.formulaUnoPoints[12]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[13]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu14" [(ngModel)]="points.formulaUnoPoints[13]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[14]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu15" [(ngModel)]="points.formulaUnoPoints[14]" type="number">
                        </div>
                    </div>
                    <div class="row" *ngIf = "points.formulaUnoPoints[15]">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <input class="form-control textinner"  name="fu16" [(ngModel)]="points.formulaUnoPoints[15]" type="number">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <label class="col-lg-6 col-md-4 col-sm-4 col-xs-4 control-label" for="fasciaintorno">Fascia con intorno:</label>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="radio">
                    ...
                    <div class="row">
                        <label class="col-lg-6 col-md-4 col-sm-4 col-xs-4 control-label" for="intorno">Intorno:</label>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="radio">
                    ...
                    <div class="row">
                        <label class="col-lg-6 col-md-4 col-sm-4 col-xs-4 control-label" for="cpareggio">Controlla pareggio:</label>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="radio">
                    ...
                    <div class="row">
                        <label class="col-lg-6 col-md-4 col-sm-4 col-xs-4 control-label" for="dpunti">Differenza punti:</label>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="radio">
                    ...
                    <div class="row">
                        <label class="col-lg-6 col-md-4 col-sm-4 col-xs-4 control-label" for="dautogol">Autogol:</label>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="radio">
                    ...
                    <div class="row">
                        <label class="col-lg-6 col-md-4 col-sm-4 col-xs-4 control-label" for="pimbattuto">Bonus portiere imbattuto:</label>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="radio">
            ...
            <div id="form-step5" class="step" *ngIf="modifiers && showModifiers">
                ...
                <div class="col-lg-12 rowb" *ngIf="modifiers">
                    <div id="mpor" class="row">
                        <label class="col-lg-5 col-md-4 col-sm-4 col-xs-4 control-label" for="mportiere">Modificatore portiere:</label>
                        ...
                        <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Impostare su Si per abilitare il calcolo del modificatore portiere"></i></div>
                    </div>
                    ...
                    <div id="mdif" class="row">
                        <label class="col-lg-5 col-md-4 col-sm-4 col-xs-4 control-label" for="mdifesa">Modificatore difesa:</label>
                        <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                            <div class="radio">
                        ...
                        <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Impostare su Si per abilitare il calcolo del modificatore difesa"></i></div>
                    </div>
                    ...
                    <div id="mcen" class="row">
                        <label class="col-lg-5 col-md-4 col-sm-4 col-xs-4 control-label" for="mcentrocampo">Modificatore centrocampo:</label>
                        <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                            <div class="radio">
                        ...
                        <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Impostare su Si per abilitare il calcolo del modificatore centrocampo"></i></div>
                    </div>
                    ...
                    <div id="matt" class="row">
                        <label class="col-lg-5 col-md-4 col-sm-4 col-xs-4 control-label" for="mattacco">Modificatore attacco:</label>
                        <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                            <div class="radio">
                        ...
                        <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Impostare su Si per abilitare il calcolo del modificatore attacco"></i></div>
                    </div>
                    ...
                    <div class="row">
                        <label class="col-lg-5 col-md-4 col-sm-4 col-xs-4 control-label" for="mfairplay">Modificatore FairPlay:</label>
                        <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                            <div class="radio">
                        ...
                        <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Impostare su Si per abilitare il calcolo del modificatore fairplay"></i></div>
                    </div>
                    ...
                    <div class="row">
                        <label class="col-lg-5 col-md-4 col-sm-4 col-xs-4 control-label" for="mfairplay">Modificatore di rendimento:</label>
                        <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
                            <div class="radio">
                        ...
                        <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1"><i class="info-ico" rel="tooltip" title="" data-original-title="Impostare su Si per abilitare il modificatore di rendimento."></i></div>
                    </div>
